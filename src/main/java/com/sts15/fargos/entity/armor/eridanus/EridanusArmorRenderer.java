...
import com.sts15.fargos.entity.armor.GenericCustomArmorRenderer;
...
public class EridanusArmorRenderer extends GenericCustomArmorRenderer<EridanusArmorItem> {
    public GeoBone bodyHeadLayerBone = null;

    public EridanusArmorRenderer(GeoModel<EridanusArmorItem> model) {
        super(model);
    }
