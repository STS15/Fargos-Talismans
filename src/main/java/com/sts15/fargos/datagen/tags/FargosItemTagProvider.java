...
public class FargosItemTagProvider extends ItemTagsProvider {
    public FargosItemTagProvider(
            PackOutput output,
            CompletableFuture<HolderLookup.Provider> lookupProvider,
            @Nullable ExistingFileHelper existingFileHelper
    ) {
        super(output, lookupProvider, CompletableFuture.completedFuture(null), Fargos.MODID, existingFileHelper);
    }

    @Override
    protected void addTags(HolderLookup.Provider provider) {
        addCurioTags(provider);
        addOrganicFishingTags(provider);
        addAbominableFishingTags(provider);
    }

    private void addOrganicFishingTags(HolderLookup.Provider provider) {
        this.tag(FargosTags.Items.FISHING_ORGANIC)
    ...
    private void addAbominableFishingTags(HolderLookup.Provider provider) {
        this.tag(FargosTags.Items.FISHING_ABOMINABLE)
                .add(Items.NETHER_STAR)
                .add(Items.WITHER_ROSE)
                .add(Items.GHAST_TEAR)
                .add(ItemInit.ABOMINABLE_ENERGY.get());
    }
    ...
    private void addCurioTags(HolderLookup.Provider provider) {
        this.tag(FargosTags.Items.CURIO_CHARM)
                ...
                .add(ItemInit.FULL_MOON_TALISMAN.get())
                ...
                .add(ItemInit.SNOWY_TALISMAN.get())
                .add(ItemInit.SPECTRAL_TALISMAN.get())
                .add(ItemInit.STORM_TALISMAN.get())
                .add(ItemInit.SUN_TALISMAN.get())
                .add(ItemInit.THORNY_TALISMAN.get())
                .add(ItemInit.TRUE_SUN_TALISMAN.get())
                ...
                .add(ItemInit.FORCE_OF_ENVIRONMENT.get())
