...
public class EridanusArmorItem  extends ExtendedArmorItem {

    public EridanusArmorItem(Type slot, Properties settings) {
        super(ArmorMaterialRegistry.ERIDANUS, slot, settings.fireResistant().rarity(Rarity.EPIC).setNoRepair().stacksTo(1));
    }
...
//            tooltipComponents.add(Component.literal("§7Double tap ↓ to toggle Eridanus' Blessing"));
    ...
    private boolean hasFullEridanusSet(Player player) {
        ItemStack head = player.getItemBySlot(EquipmentSlot.HEAD);
        ItemStack chest = player.getItemBySlot(EquipmentSlot.CHEST);
        ItemStack legs = player.getItemBySlot(EquipmentSlot.LEGS);
        ItemStack feet = player.getItemBySlot(EquipmentSlot.FEET);

        return head.getItem() instanceof EridanusArmorItem &&
                chest.getItem() instanceof EridanusArmorItem &&
                legs.getItem() instanceof EridanusArmorItem &&
                feet.getItem() instanceof EridanusArmorItem;
    }
    ...
    public GeoArmorRenderer<?> supplyRenderer() {
        return new EridanusArmorRenderer(new EridanusArmorModel());
    }
