...
public class AmberHorseshoeBalloonItem extends TalismanItem implements ICurioItem, Amber_Horseshoe_Balloon_Provider {

    private static final Logger LOGGER = LogManager.getLogger(Fargos.MODID);
    public static final String charmName = "amber_horseshoe_balloon";

    public AmberHorseshoeBalloonItem() {
    ...
    public static class Events {
        ...
        public static void onIncomingDamage(LivingIncomingDamageEvent event) {
            ...
            if (source.is(fallDamageType)) {
                boolean equipped = CuriosApi.getCuriosHelper().findEquippedCurio(stack -> stack.getItem() instanceof Amber_Horseshoe_Balloon_Provider, player).isPresent();
