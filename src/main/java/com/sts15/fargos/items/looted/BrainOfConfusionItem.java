...
public class BrainOfConfusionItem extends TalismanItem implements ICurioItem, Brain_Of_Confusion_Provider {

    private static final Logger LOGGER = LogManager.getLogger(Fargos.MODID);
    public static final String charmName = "brain_of_confusion";

    public BrainOfConfusionItem() {
    ...
    public static class Events {
        ...
        public static void onLivingHurt(LivingIncomingDamageEvent event) {
            ...
            boolean hasBrainEquipped = CuriosApi.getCuriosHelper()
