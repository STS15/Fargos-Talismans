    ...
    public static class Events {
        ...
        public static void onLivingHurt(LivingIncomingDamageEvent event) {
            ...
            if (	  source.is(DamageTypeArrow)
                ...
                if (player.hasEffect(EffectsInit.AMETHYST_TALISMAN_EFFECT) || CuriosApi.getCuriosHelper().findEquippedCurio(stack -> stack.getItem() instanceof Amethyst_Talisman_Provider, player).isPresent()) {
